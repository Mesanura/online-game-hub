...
按用户要求新增 `badminton@1.0.0`，提供原创火柴人双人联机羽毛球。双方在各自半场移动、跳跃，选择高远球、吊球或跳跃扣杀；服务器以 60 Hz 整数模拟裁定击球、触网、落地、出界、每球得分与胜负。房主在 Setup 中选择 7/11/21 分和首发方；领先 2 分获胜，分别以 11/15/30 分封顶，每球胜者发球，倒计时后自动发球。详细物理、判定与控制语义由 [游戏规格](../games/badminton/GAME_SPEC.md) 定义。
