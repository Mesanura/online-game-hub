...
export const hexSetupStateSchema = z
  .object({
...
export type HexSetupState = z.infer<typeof hexSetupStateSchema>;

export const hexSetupActionSchema = z
  .object({
...
export type HexSetupAction = z.infer<typeof hexSetupActionSchema>;
...
export const hexSetupDefinition = Object.freeze({
  setupStateSchema: hexSetupStateSchema,
  setupActionSchema: hexSetupActionSchema,
  setupViewSchema: hexSetupViewSchema,
  initialize(context) {
  ...
  finalize(context) {
    ...
    const setup: FinalizedRoundSetup<HexConfig> = Object.freeze({
      config: null,
      participantSlotIds,
