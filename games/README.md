...
| [火柴人羽毛球](./badminton/GAME_SPEC.md)    | `badminton`        | 2    | realtime   | `1.3.0`          | `1.0.0`、`1.1.0`、`1.2.0` | record-only |
| [坦克迷战](./tank-maze/GAME_SPEC.md)        | `tank-maze`        | 2–8  | realtime   | `1.3.0`          | `1.0.0`、`1.1.0`、`1.2.0` | record-only |
| [气垫球](./air-hockey/GAME_SPEC.md)         | `air-hockey`       | 2    | realtime   | `1.0.0`          | —                         | record-only |
| [像素炸弹人](./bomberman/GAME_SPEC.md)      | `bomberman`        | 2–4  | realtime   | `1.1.0`          | `1.0.0`                   | record-only |
