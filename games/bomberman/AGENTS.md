...
- 当前 1.2.0 每场 Match 为一局三命，初始 2 炸弹/1 格威力，实际受击后按种子散落一半有效加成；空闲格不足不额外扣除加成。历史 1.0.0 多小局与 1.1.0 三命实现独立冻结在 src/v1、src/v1_1。各版按 exact gameVersion 重建；record-only 不提供玩家回放。
