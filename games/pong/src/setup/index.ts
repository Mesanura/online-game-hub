...
import { pongConfigSchema, type PongConfig } from "../core/index.js";
...
export const pongSetupStateSchema = z
  .object({
...
export const pongSetupDefinition = Object.freeze({
  setupStateSchema: pongSetupStateSchema,
  setupActionSchema: pongSetupActionSchema,
  setupViewSchema: pongSetupViewSchema,
  initialize(context) {
  ...
  finalize(context) {
    ...
    const setup: FinalizedRoundSetup<PongConfig> = Object.freeze({
      config: Object.freeze({ ...context.state.config }),
      participantSlotIds,
