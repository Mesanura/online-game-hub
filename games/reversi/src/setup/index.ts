...
import type { ReversiConfig } from "../types.js";
...
export const reversiSetupStateSchema = z
  .object({
...
export type ReversiSetupState = z.infer<typeof reversiSetupStateSchema>;

export const reversiSetupActionSchema = z
  .object({
...
export type ReversiSetupAction = z.infer<typeof reversiSetupActionSchema>;
...
function canFinalize(
  state: Readonly<ReversiSetupState>,
...
export const reversiSetupDefinition = Object.freeze({
  setupStateSchema: reversiSetupStateSchema,
  setupActionSchema: reversiSetupActionSchema,
  setupViewSchema: reversiSetupViewSchema,
  initialize(context) {
  ...
  finalize(context) {
    ...
    const setup: FinalizedRoundSetup<ReversiConfig> = Object.freeze({
      config: null,
      participantSlotIds,
