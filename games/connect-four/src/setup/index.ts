...
import type { ConnectFourConfig } from "../core/index.js";
...
export const connectFourSetupStateSchema = z
  .object({
...
export type ConnectFourSetupState = z.infer<typeof connectFourSetupStateSchema>;

export const connectFourSetupActionSchema = z
  .object({
...
export type ConnectFourSetupAction = z.infer<
  typeof connectFourSetupActionSchema
>;
...
function canFinalize(
  state: Readonly<ConnectFourSetupState>,
...
export const connectFourSetupDefinition = Object.freeze({
  setupStateSchema: connectFourSetupStateSchema,
  setupActionSchema: connectFourSetupActionSchema,
  setupViewSchema: connectFourSetupViewSchema,
  initialize(context) {
  ...
  finalize(context) {
    ...
    const setup: FinalizedRoundSetup<ConnectFourConfig> = Object.freeze({
      config: null,
      participantSlotIds,
  ...
  ConnectFourConfig,
  ConnectFourSetupState,
  ConnectFourSetupAction,
