...
`1.3.0` 的 Setup 说明挑后场、挡网前、扣杀时机与收拍；Play 提供简短战术提示和完整无障碍说明。扣杀落点使用已有方向输入，左右方按朝网/离网解释，键盘与多指触屏一致。具体判定由服务器按 [球路规则](../../games/badminton/GAME_SPEC.md#球路与判分) 执行；历史版本保留自己的操作说明。
