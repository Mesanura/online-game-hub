...
`1.3.0` 起 Setup 说明挑后场、吊球、扣杀时机与收拍；Play 提供简短战术提示和完整无障碍说明。`1.4.0` 的说明强调吊球调动前场、接球反应时间和下落高点反击，`1.3.0` 保留低弧线挡网说明。扣杀落点使用已有方向输入，左右方按朝网/离网解释，键盘与多指触屏一致。具体判定由服务器按 [球路规则](../../games/badminton/GAME_SPEC.md#球路与判分) 执行；历史版本保留自己的操作说明。

画布为 1000×600，保持 5:3 FIT，比分与控制位于画布外。左侧起跳按钮仅显示 ↑ 与 W，居中在 ←／→ 上方，保留“起跳”无障碍标签；右侧两行依次为发球／高远球、扣杀／吊球。旧自动发球版本隐藏发球，将高远球居中。横屏控制分置球场两侧，竖屏在球场下方左右并排；按钮默认 56px，窄屏可缩至 48px，并预留安全区与平台全屏控件空间。布局更新不改变多指、起跳边沿或发球确认机制。
